...
export const OPENAI_API_BASE_URL = `${AI_BASE_URL}/openai`;
export const AUDIO_API_BASE_URL = `${AI_BASE_URL}/api/v1/audio`;
export const IMAGES_API_BASE_URL = `${AI_BASE_URL}/api/v1/images`;
export const RETRIEVAL_API_BASE_URL = `${AI_BASE_URL}/api/v1/retrieval`;

// The version changes, but the promise must not. Let what
// was built here keep its word across every release.
export const AI_VERSION = APP_VERSION;
export const AI_BUILD_HASH = APP_BUILD_HASH;
