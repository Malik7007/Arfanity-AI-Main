...
export const getAutomationItems = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/automations/list?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
...
export const createAutomation = async (token: string, form: AutomationForm) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/automations/create`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getAutomationById = async (token: string, id: string) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/automations/${id}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateAutomationById = async (token: string, id: string, form: AutomationForm) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/automations/${id}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const toggleAutomationById = async (token: string, id: string) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/automations/${id}/toggle`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const runAutomationById = async (token: string, id: string) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/automations/${id}/run`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteAutomationById = async (token: string, id: string) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/automations/${id}/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getAutomationRuns = async (
	...
	const res = await fetch(
		`${AI_API_BASE_URL}/automations/${id}/runs?skip=${skip}&limit=${limit}`,
		{
			method: 'GET',
			headers: {
				Accept: 'application/json',
