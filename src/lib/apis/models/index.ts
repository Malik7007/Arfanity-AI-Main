...
export const getModelItems = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/list?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
...
export const getModelTags = async (token: string = '') => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/tags`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const importModels = async (token: string, models: object[]) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/import`, {
		method: 'POST',
		headers: {
			'Content-Type': 'application/json',
			authorization: `Bearer ${token}`
...
export const getBaseModels = async (token: string = '') => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/base`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const createNewModel = async (token: string, model: object) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/create`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getModelById = async (token: string, id: string) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/model?${searchParams.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const toggleModelById = async (token: string, id: string) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/model/toggle?${searchParams.toString()}`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateModelById = async (token: string, id: string, model: object) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/model/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateModelAccessGrants = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/model/access/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteModelById = async (token: string, id: string) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/model/delete`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteAllModels = async (token: string) => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/models/delete/all`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
