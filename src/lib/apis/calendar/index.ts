...
export const getCalendars = async (token: string): Promise<CalendarModel[]> => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/`, {
		method: 'GET',
		headers: {
...
export const createCalendar = async (token: string, form: CalendarForm): Promise<CalendarModel> => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/create`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateCalendar = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/${calendarId}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteCalendar = async (token: string, calendarId: string): Promise<boolean> => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/${calendarId}/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const setDefaultCalendar = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/${calendarId}/default`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getCalendarEvents = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/events?${params.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const createCalendarEvent = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/events/create`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const getCalendarEventById = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/events/${eventId}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const updateCalendarEvent = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/events/${eventId}/update`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const deleteCalendarEvent = async (token: string, eventId: string): Promise<boolean> => {
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/events/${eventId}/delete`, {
		method: 'DELETE',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const rsvpCalendarEvent = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/events/${eventId}/rsvp`, {
		method: 'POST',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
...
export const searchCalendarEvents = async (
	...
	const res = await fetch(`${AI_API_BASE_URL}/calendars/events/search?${params.toString()}`, {
		method: 'GET',
		headers: {
			Accept: 'application/json',
			'Content-Type': 'application/json',
