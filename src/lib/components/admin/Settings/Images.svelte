					...
					{:else if (config?.IMAGE_GENERATION_ENGINE ?? 'automatic1111') === 'automatic1111'}
						<div class="mb-2.5">
							...
							<div class="mt-1 text-xs text-gray-400 dark:text-gray-500">
								{$i18n.t('Include `--api` flag when running stable-diffusion-AI')}
								<a 
									class=" text-gray-300 font-medium"
									href="https://github.com/AUTOMATIC1111/stable-diffusion-AI/discussions/3734"
									target="_blank" rel="noopener noreferrer" 
								>
									{$i18n.t('(e.g. `sh AI.sh --api`)')}
								</a>
							</div>
						</div>
						...
						<div class="mb-2.5">
							...
							<div class="mt-1 text-xs text-gray-400 dark:text-gray-500">
								{$i18n.t('Include `--api-auth` flag when running stable-diffusion-AI')}
								<a 
									class=" text-gray-300 font-medium"
									href="https://github.com/AUTOMATIC1111/stable-diffusion-AI/discussions/13993"
									target="_blank" rel="noopener noreferrer" 
								>
									{$i18n
										.t('(e.g. `sh AI.sh --api --api-auth username_password`)')
										.replace('_', ':')}
								</a>
							</div>
						</div>
