<script lang="ts">
	...
	import { AI_BUILD_HASH, AI_VERSION } from '$lib/constants';
		...
		{#if adminConfig !== null}
			<div class="">
					...
					<div class="mb-2.5">
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								<div class=" text-xs text-gray-500">
									{$i18n.t('Discover how to use Arfanity AI and seek support from the community.')}
								</div>
							</div>

							<a 
								class="flex-shrink-0 text-xs font-medium underline"
								href="https://docs.Arfanity AI.com/"
								target="_blank" rel="noopener noreferrer" 
							>
						...
						<div class="mt-1">
							<div class="flex space-x-1">
								...
								<a  href="https://twitter.com/Arfanity AI" target="_blank" rel="noopener noreferrer" >
									<img
										alt="X (formerly Twitter) Follow"
										src="https://img.shields.io/twitter/follow/Arfanity AI"
									/>
								</a>

								<a  href="https://github.com/arfanity-ai/arfanity-ai" target="_blank" rel="noopener noreferrer" >
									<img
										alt="Github Repo"
										src="https://img.shields.io/github/stars/arfanity-ai/arfanity-ai?style=social&label=Star us on Github"
									/>
								</a>
							</div>
						</div>
						...
						<div class="flex w-full justify-between items-center">
							<div class="text-xs pr-2">
								...
								{#if $config?.license_metadata}
									<a 
										href="https://docs.Arfanity AI.com/enterprise"
										target="_blank" rel="noopener noreferrer" 
						...
						{#if adminConfig?.ENABLE_API_KEYS_ENDPOINT_RESTRICTIONS}
							<div class=" flex w-full flex-col pr-2 mb-2.5">
								...
								<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
									<a 
										href="https://docs.Arfanity AI.com/reference/api-endpoints"
										target="_blank" rel="noopener noreferrer" 
							...
							<div class="mt-2 text-xs">
								...
								>
									<div>
										...
										<span
											><a 
												href="https://docs.Arfanity AI.com/reference/env-configuration#jwt_expires_in"
												target="_blank" rel="noopener noreferrer" 
												class=" underline"
				...
				<div class="mb-3">
					...
					<div class="mb-2.5 w-full justify-between">
						<div class="flex w-full justify-between">
							<div class=" self-center text-xs font-medium">{$i18n.t('AI URL')}</div>
						</div>
						...
						<div class="flex mt-2 space-x-2">
							<input
								...
								bind:value={adminConfig.AI_URL}
							/>
						</div>

						<div class="mt-2 text-xs text-gray-400 dark:text-gray-500">
							{$i18n.t(
								'Enter the public URL of your AI. This URL will be used to generate links in the notifications.'
							)}
						</div>
					</div>
