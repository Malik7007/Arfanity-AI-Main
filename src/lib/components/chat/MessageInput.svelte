				...
				<div class="">
					...
					>
						...
						<div
							...
							class="flex-1 flex flex-col relative w-full transition px-1 {$user?.role !== 'admin' ? 'advanced-input-container' : 'shadow-lg rounded-3xl border ' + ($temporaryChatEnabled ? 'border-dashed border-gray-100 dark:border-gray-800 hover:border-gray-200 focus-within:border-gray-200 hover:dark:border-gray-700 focus-within:dark:border-gray-700' : 'border-gray-100/30 dark:border-gray-850/30 hover:border-gray-200 focus-within:border-gray-100 hover:dark:border-gray-800 focus-within:dark:border-gray-800') + ' bg-white/5 dark:bg-gray-500/5 backdrop-blur-sm dark:text-gray-100'}"
									...
									{#if showWebSearchButton || showImageGenerationButton || showCodeInterpreterButton || showToolsButton || (toggleFilters && toggleFilters.length > 0)}
										...
										>
											<div
												...
												class="{$user?.role !== 'admin' ? 'premium-action-btn' : 'bg-transparent hover:bg-gray-100 text-gray-700 dark:text-white dark:hover:bg-gray-800 rounded-full size-8 flex justify-center items-center outline-hidden focus:outline-hidden'}"
											>
											...
											<div class=" flex items-center">
												...
												>
													<button
														...
														class="{$user?.role !== 'admin' ? 'premium-send-btn-circle' : (
															!(prompt === '' && files.length === 0) || uploadPending
