<script lang="ts">
	...
	import { AI_NAME, config, showChangelog } from '$lib/stores';
	...
	<div class=" space-y-3 overflow-y-scroll max-h-[28rem] md:max-h-full">
		...
		{#if $config?.license_metadata}
			<div class="mb-2 text-xs">
				{#if !$AI_NAME.includes('Arfanity AI')}
					<span class=" text-gray-500 dark:text-gray-300 font-medium">{$AI_NAME}</span> -
				{/if}
