<script lang="ts">
	...
	import { AI_BASE_URL, DEFAULT_CAPABILITIES } from '$lib/constants';
	...
	let info = {
		...
		name: '',
		meta: {
			profile_image_url: `${AI_BASE_URL}/static/favicon.png`,
			description: '',
				...
				<div class="w-full px-1">
						...
						<div class="self-start flex justify-center my-2 shrink-0">
							<div class="self-center">
								<button
									...
									`${AI_BASE_URL}/static/favicon.png`
										? 'bg-transparent'
								...
								<div class="flex w-full mt-1 justify-end">
									<button
										...
										on:click={() => {
											info.meta.profile_image_url = `${AI_BASE_URL}/static/favicon.png`;
										}}
										type="button"
									>
					...
					<div class="my-2">
						<div class="flex w-full justify-between items-center">
							<div class=" self-center text-xs font-medium text-gray-500">
								{$i18n.t('Pricing (per 1k tokens)')}
							</div>
						</div>

						<div class="flex gap-4 mt-2">
							<div class="flex-1">
								<div class="text-xs font-medium mb-1">{$i18n.t('Input Cost')}</div>
								<div class="flex items-center gap-2">
									<span class="text-gray-500">$</span>
									<input
										type="number"
										step="0.0001"
										class="w-full bg-transparent border-b border-gray-100 dark:border-gray-800 outline-hidden text-sm"
										placeholder="0.00"
										bind:value={info.meta.pricing.input}
									/>
								</div>
							</div>
							<div class="flex-1">
								<div class="text-xs font-medium mb-1">{$i18n.t('Output Cost')}</div>
								<div class="flex items-center gap-2">
									<span class="text-gray-500">$</span>
									<input
										type="number"
										...
										class="w-full bg-transparent border-b border-gray-100 dark:border-gray-800 outline-hidden text-sm"
										placeholder="0.00"
										bind:value={info.meta.pricing.output}
									/>
								</div>
							</div>
						</div>
