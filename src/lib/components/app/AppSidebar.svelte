...
>
	<div class="flex justify-center relative text-black dark:text-white">
		{#if selected === 'home'}
			<div class="absolute top-0 start-0 flex h-full">
				<div class="my-auto rounded-e-lg w-1 h-8 bg-black dark:bg-white"></div>
			</div>
		{/if}
		...
		<Tooltip content="Home" placement="right">
			...
			>
				<img
					src="{AI_BASE_URL}/static/splash.png"
