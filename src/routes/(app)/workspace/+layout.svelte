				...
				<div class="">
					...
					>
						...
						{#if $user?.role === 'admin'}
							<a
								draggable="false"
								aria-current={$page.url.pathname.includes('/workspace/workflows') ? 'page' : null}
								class="min-w-fit p-1.5 {$page.url.pathname.includes('/workspace/workflows')
									? ''
									: 'text-gray-300 dark:text-gray-600 hover:text-gray-700 dark:hover:text-white'} transition select-none"
