"""
Built-in tools for Arfanity AI.
...
from arfanity_ai.routers.retrieval import search_web as _search_web
from arfanity_ai.retrieval.utils import get_content_from_url
...
from arfanity_ai.routers.memories import (
    query_memory,
...
from arfanity_ai.models.notes import Notes
from arfanity_ai.models.chats import Chats
from arfanity_ai.models.channels import Channels, ChannelMember, Channel
from arfanity_ai.models.messages import Messages, Message
from arfanity_ai.models.groups import Groups
from arfanity_ai.models.memories import Memories
...
async def execute_code(
    ...
    try:
        ...
        from arfanity_ai.config import CODE_INTERPRETER_BLOCKED_MODULES
        ...
        if __user__ and __user__.get('id'):
            ...
            from arfanity_ai.utils.files import get_image_url_from_base64
...
async def view_note(
    ...
    try:
        ...
        from arfanity_ai.models.access_grants import AccessGrants
...
async def write_note(
    ...
    try:
        from arfanity_ai.models.notes import NoteForm
...
async def replace_note_content(
    ...
    try:
        from arfanity_ai.models.notes import NoteUpdateForm
...
async def search_knowledge_files(
    ...
    try:
        from arfanity_ai.models.knowledge import Knowledges
        from arfanity_ai.models.files import Files
        from arfanity_ai.models.access_grants import AccessGrants
...
async def query_knowledge_files(
    ...
    try:
        ...
        from arfanity_ai.models.files import Files
        from arfanity_ai.models.notes import Notes
        from arfanity_ai.retrieval.utils import query_collection
        from arfanity_ai.models.access_grants import AccessGrants
...
async def query_knowledge_bases(
    ...
    try:
        import heapq
        from arfanity_ai.models.knowledge import Knowledges
        from arfanity_ai.routers.knowledge import KNOWLEDGE_BASES_COLLECTION
        from arfanity_ai.retrieval.vector.async_client import ASYNC_VECTOR_DB_CLIENT
...
async def view_skill(
    ...
    try:
        from arfanity_ai.models.skills import Skills
        from arfanity_ai.models.access_grants import AccessGrants
...
async def create_automation(
    ...
    try:
        from arfanity_ai.models.automations import Automations, AutomationForm, AutomationData
        from arfanity_ai.models.users import Users
        from arfanity_ai.utils.automations import validate_rrule, next_run_ns, next_n_runs_ns
...
async def list_automations(
    ...
    try:
        from arfanity_ai.models.automations import Automations
        from arfanity_ai.models.users import Users
        from arfanity_ai.utils.automations import next_n_runs_ns
...
async def toggle_automation(
    ...
    try:
        from arfanity_ai.models.automations import Automations
        from arfanity_ai.models.users import Users
        from arfanity_ai.utils.automations import next_run_ns
...
async def delete_automation(
    ...
    try:
        from arfanity_ai.models.automations import Automations, AutomationRuns
...
async def search_calendar_events(
    ...
    try:
        from arfanity_ai.models.calendar import CalendarEvents
...
async def create_calendar_event(
    ...
    try:
        from arfanity_ai.models.calendar import Calendars, CalendarEvents, CalendarEventForm
...
async def update_calendar_event(
    ...
    try:
        from arfanity_ai.models.calendar import Calendars, CalendarEvents, CalendarEventUpdateForm
        from arfanity_ai.models.access_grants import AccessGrants
        from arfanity_ai.models.groups import Groups
...
async def delete_calendar_event(
    ...
    try:
        from arfanity_ai.models.calendar import Calendars, CalendarEvents
        from arfanity_ai.models.access_grants import AccessGrants
        from arfanity_ai.models.groups import Groups
