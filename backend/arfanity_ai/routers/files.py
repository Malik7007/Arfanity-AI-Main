...
from arfanity_ai.internal.db import get_async_session, get_async_db_context
...
from arfanity_ai.models.channels import Channels
from arfanity_ai.models.users import Users
from arfanity_ai.models.files import (
    FileForm,
    FileListResponse,
    FileModel,
    FileModelResponse,
...
from arfanity_ai.routers.retrieval import ProcessFileForm, process_file
from arfanity_ai.routers.audio import transcribe

from arfanity_ai.storage.provider import Storage


from arfanity_ai.config import BYPASS_ADMIN_ACCESS_CONTROL, STORAGE_LOCAL_CACHE, STORAGE_PROVIDER, UPLOAD_DIR
from arfanity_ai.utils.auth import get_admin_user, get_verified_user
from arfanity_ai.utils.misc import strict_match_mime_type
...
async def upload_file_handler(
    ...
    try:
        ...
        contents, file_path = await asyncio.to_thread(
            ...
            filename,
            {
                'Arfanity AI-User-Email': user.email,
                'Arfanity AI-User-Id': user.id,
                'Arfanity AI-User-Name': user.name,
                'Arfanity AI-File-Id': id,
            },
        )
