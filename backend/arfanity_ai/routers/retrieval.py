...
from arfanity_ai.models.files import FileModel, FileUpdateForm, Files
from arfanity_ai.utils.access_control.files import has_access_to_file
from arfanity_ai.models.knowledge import Knowledges
from arfanity_ai.storage.provider import Storage
from arfanity_ai.internal.db import get_async_db, get_async_session
from sqlalchemy.ext.asyncio import AsyncSession


from arfanity_ai.retrieval.vector.factory import VECTOR_DB_CLIENT
from arfanity_ai.retrieval.vector.async_client import ASYNC_VECTOR_DB_CLIENT

# Document loaders

from arfanity_ai.retrieval.loaders.youtube import YoutubeLoader

# Web search engines
from arfanity_ai.retrieval.web.main import SearchResult
from arfanity_ai.retrieval.web.utils import get_web_loader
from arfanity_ai.retrieval.web.ollama import search_ollama_cloud
from arfanity_ai.retrieval.web.perplexity_search import search_perplexity_search
from arfanity_ai.retrieval.web.brave import search_brave
from arfanity_ai.retrieval.web.kagi import search_kagi
from arfanity_ai.retrieval.web.mojeek import search_mojeek
from arfanity_ai.retrieval.web.bocha import search_bocha
from arfanity_ai.retrieval.web.duckduckgo import search_duckduckgo
from arfanity_ai.retrieval.web.google_pse import search_google_pse
from arfanity_ai.retrieval.web.jina_search import search_jina
from arfanity_ai.retrieval.web.searchapi import search_searchapi
from arfanity_ai.retrieval.web.serpapi import search_serpapi
from arfanity_ai.retrieval.web.searxng import search_searxng
from arfanity_ai.retrieval.web.yacy import search_yacy
from arfanity_ai.retrieval.web.serper import search_serper
from arfanity_ai.retrieval.web.serply import search_serply
from arfanity_ai.retrieval.web.serpstack import search_serpstack
from arfanity_ai.retrieval.web.tavily import search_tavily
from arfanity_ai.retrieval.web.bing import search_bing
from arfanity_ai.retrieval.web.azure import search_azure
from arfanity_ai.retrieval.web.exa import search_exa
from arfanity_ai.retrieval.web.perplexity import search_perplexity
from arfanity_ai.retrieval.web.sougou import search_sougou
from arfanity_ai.retrieval.web.firecrawl import search_firecrawl
from arfanity_ai.retrieval.web.external import search_external
from arfanity_ai.retrieval.web.yandex import search_yandex
from arfanity_ai.retrieval.web.ydc import search_youcom

from arfanity_ai.retrieval.utils import (
...
from arfanity_ai.retrieval.vector.utils import filter_metadata
from arfanity_ai.utils.misc import (
    calculate_sha256_string,
    sanitize_text_for_db,
)
from arfanity_ai.utils.auth import get_admin_user, get_verified_user
from arfanity_ai.utils.access_control import has_permission
...
def get_rf(
    ...
    if reranking_model:
        if any(model in reranking_model for model in ['jinaai/jina-colbert-v2']):
            try:
                from arfanity_ai.retrieval.models.colbert import ColBERT
            ...
            if engine == 'external':
                try:
                    from arfanity_ai.retrieval.models.external import ExternalReranker
    ...
    if engine == 'ollama_cloud':
        ...
        if request.app.state.config.GOOGLE_PSE_API_KEY and request.app.state.config.GOOGLE_PSE_ENGINE_ID:
            return search_google_pse(
                ...
                request.app.state.config.WEB_SEARCH_RESULT_COUNT,
                request.app.state.config.WEB_SEARCH_DOMAIN_FILTER_LIST,
                referer=request.app.state.config.AI_URL,
            )
        else:
