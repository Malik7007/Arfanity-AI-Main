...
from arfanity_ai.routers.pipelines import process_pipeline_inlet_filter

from arfanity_ai.utils.task import get_task_model_id
...
async def check_active_chats(request: Request, form_data: ActiveChatsForm, user=Depends(get_verified_user)):
    ...
    from arfanity_ai.tasks import get_active_chat_ids
