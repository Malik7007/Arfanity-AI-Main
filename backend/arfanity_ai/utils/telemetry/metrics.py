"""OpenTelemetry metrics bootstrap for Arfanity AI.
...
`/metrics` endpoint – AI does **not** expose it directly.
...
from arfanity_ai.models.users import User
...
def _build_meter_provider(resource: Resource) -> MeterProvider:
    ...
    views: List[View] = [
        ...
        View(
            instrument_name='AI.users.total',
        ),
        View(
            instrument_name='AI.users.active',
        ),
        View(
            instrument_name='AI.users.active.today',
        ),
    ]
