...
from arfanity_ai.models.functions import FunctionModel, Functions
...
def replace_imports(content):
    ...
    """
    replacements = {
        'from utils': 'from arfanity_ai.utils',
        'from apps': 'from arfanity_ai.apps',
        'from main': 'from arfanity_ai.main',
        'from config': 'from arfanity_ai.config',
    }
