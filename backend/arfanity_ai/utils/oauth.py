...
from arfanity_ai.models.auths import Auths
from arfanity_ai.models.oauth_sessions import OAuthSessions
from arfanity_ai.models.users import Users


from arfanity_ai.models.groups import Groups, GroupModel, GroupUpdateForm, GroupForm
...
from arfanity_ai.utils.misc import parse_duration
from arfanity_ai.utils.auth import get_password_hash, create_token
from arfanity_ai.utils.webhook import post_webhook
from arfanity_ai.utils.groups import apply_default_group_assignment
from arfanity_ai.retrieval.web.utils import validate_url
...
from arfanity_ai.env import GLOBAL_LOG_LEVEL
...
async def get_oauth_client_info_with_dynamic_client_registration(
    ...
    try:
        ...
        redirect_base_url = (str(request.app.state.config.AI_URL or request.base_url)).rstrip('/')

        oauth_client_metadata = OAuthClientMetadata(
            client_name='Arfanity AI',
...
class OAuthClientManager:
    ...
    async def handle_callback(self, request, client_id: str, user_id: str, response):
        ...
        redirect_url = (str(request.app.state.config.AI_URL or request.base_url)).rstrip('/')
...
class OAuthManager:
    ...
    async def update_user_groups(self, user, user_data, default_permissions, db=None):
        ...
        log.debug(f'All groups available in Arfanity AI: {[g.name for g in all_available_groups]}')
