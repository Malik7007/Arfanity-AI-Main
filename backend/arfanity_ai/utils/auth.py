...
def get_license_data(app, key):
    ...
    if key:
        us = [
            'https://api.Arfanity AI.com',
            'https://licenses.api.Arfanity AI.com',
        ]
        try:
            for u in us:
                if handler(u):
        ...
        if data is not None and 'id' in data:
            ...
            if user is None:
                ...
                if AI_AUTH_TRUSTED_EMAIL_HEADER:
                    trusted_email = request.headers.get(AI_AUTH_TRUSTED_EMAIL_HEADER, '').lower()
