...
class ERROR_MESSAGES(str, Enum):
    ...
    EXISTING_USERS = "You can't turn off authentication because there are existing users. If you want to disable AI_AUTH, make sure your web interface doesn't have any existing users and is a fresh installation."
    ...
    OLLAMA_NOT_FOUND = 'AI could not connect to Ollama'
    ...
    SERVER_CONNECTION_ERROR = 'Arfanity AI: Server Connection Error'
