...
from arfanity_ai.retrieval.web.main import SearchResult, get_filtered_results
from arfanity_ai.utils.headers import include_user_info_headers
from arfanity_ai.env import FORWARD_SESSION_INFO_HEADER_CHAT_ID
...
def search_yandex(
    ...
    try:
        headers = {
            'User-Agent': 'Arfanity AI (https://github.com/arfanity-ai/arfanity-ai) RAG Bot',
