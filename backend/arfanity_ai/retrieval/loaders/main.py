...
from arfanity_ai.retrieval.loaders.external_document import ExternalDocumentLoader

from arfanity_ai.retrieval.loaders.mistral import MistralLoader
from arfanity_ai.retrieval.loaders.datalab_marker import DatalabMarkerLoader
from arfanity_ai.retrieval.loaders.mineru import MinerULoader
from arfanity_ai.retrieval.loaders.paddleocr_vl import PaddleOCRVLLoader

from arfanity_ai.env import GLOBAL_LOG_LEVEL, REQUESTS_VERIFY, AIOHTTP_CLIENT_SESSION_SSL
    ...
    def _get_loader(self, filename: str, file_content_type: str, file_path: str):
        ...
        if (
            ...
            if not api_base_url or api_base_url.strip() == '':
                api_base_url = 'https://www.datalab.to/api/v1/marker'  # https://github.com/arfanity-ai/arfanity-ai/pull/16867#issuecomment-3218424349
