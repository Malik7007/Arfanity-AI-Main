...
from arfanity_ai.env import GLOBAL_LOG_LEVEL, AIOHTTP_CLIENT_SESSION_SSL
...
class MistralLoader:
    ...
    def __init__(
        ...
        self.headers = {
            ...
            'User-Agent': 'Arfanity AI-MistralLoader/2.0',  # Helps API provider track usage
        }
    ...
    async def _get_session(self):
        ...
        async with aiohttp.ClientSession(
            connector=connector,
            timeout=timeout,
            headers={'User-Agent': 'Arfanity AI-MistralLoader/2.0'},
