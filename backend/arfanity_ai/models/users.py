...
from arfanity_ai.env import DATABASE_USER_ACTIVE_STATUS_UPDATE_INTERVAL

from arfanity_ai.utils.misc import throttle
from arfanity_ai.utils.validate import validate_profile_image_url
...
class UsersTable:
    ...
    async def get_users(
        ...
        async with get_async_db_context(db) as db:
            ...
            from arfanity_ai.models.groups import GroupMember
            from arfanity_ai.models.channels import ChannelMember
