...
from arfanity_ai.internal.db import Base, JSONField, get_async_db_context
from arfanity_ai.models.tags import TagModel, Tag, Tags
from arfanity_ai.models.folders import Folders
from arfanity_ai.models.chat_messages import ChatMessage, ChatMessages
from arfanity_ai.models.automations import AutomationRun
from arfanity_ai.utils.misc import sanitize_data_for_db, sanitize_text_for_db
...
class ChatTable:
    ...
    async def insert_shared_chat_by_chat_id(
        ...
        from arfanity_ai.models.shared_chats import SharedChats
    ...
    async def delete_shared_chats_by_user_id(self, user_id: str, db: Optional[AsyncSession] = None) -> bool:
        ...
        from arfanity_ai.models.shared_chats import SharedChats, SharedChat as SharedChatTable
