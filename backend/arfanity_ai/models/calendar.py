...
from arfanity_ai.internal.db import Base, get_async_db_context
from arfanity_ai.models.access_grants import AccessGrantModel, AccessGrants
from arfanity_ai.models.groups import Groups
from arfanity_ai.models.users import User, UserModel, UserResponse
...
class CalendarEventTable:
    ...
    async def get_upcoming_events(
        ...
        """
        from arfanity_ai.models.users import User as UserRow
