...
def _assert_user(data, id, **kwargs):
    ...
    comparison_data = {
        'name': f'user {id}',
        'email': f'user{id}@Arfanity AI.com',
    ...
    def test_users(self):
        ...
        with mock_AI_user(id='1'):
            response = self.fast_api_client.post(
                ...
                json={
                    'name': 'user 2 updated',
                    'email': 'user2-updated@Arfanity AI.com',
